"""
Django settings for bargetrader project.
...
SECRET_KEY = 'django-insecure-@-kw&@+@bj9!b9+q2514hw843@rcyy4i6czgkf!1imk23#q-*g'
...
WSGI_APPLICATION = 'bargetrader.wsgi.application'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'trading/static/trading')]
...
LOGGING = {
    ...
    'loggers': {
        ...
        'trading': {  # Assuming 'trading' is the name of your app
            'handlers': ['console'],
            'level': 'DEBUG',
        },
    },
